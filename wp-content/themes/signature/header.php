...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$signature_description = get_bloginfo( 'description', 'display' );
			if ( $signature_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $signature_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
